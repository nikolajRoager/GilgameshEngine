...
///@brief The best I can do, without using AVX: Use state indices to look up matching values in the matrix. For loops have been manually unrolled, to test if it is faster
